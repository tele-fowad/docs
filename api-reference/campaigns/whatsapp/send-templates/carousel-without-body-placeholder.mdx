---
title: "Send Carousel Template Message without Body Placeholder"
sidebarTitle: "Carousel Template without Placeholder"
description: "This API is used to send the carousel template message without the body
