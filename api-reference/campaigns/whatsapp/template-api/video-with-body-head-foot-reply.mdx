---
title: "Video Template with Body, Header, Footer & Quick Reply"
sidebarTitle: "Video with Head, Foot & Reply"
description: "This API is used for creating video templates with body, header, footer and
quick reply"
