---
title: "Text Template with Body, Header and Footer"
sidebarTitle: "Text with Body Header & Footer"
description: "This API is used for creating text templates with body, header and footer."
