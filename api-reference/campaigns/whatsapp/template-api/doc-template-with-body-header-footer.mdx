---
title: "Document Template with Body, Header & Footer"
sidebarTitle: "Document with Header & Footer"
description: "This API is used for creating document templates with body, header and
footer."
