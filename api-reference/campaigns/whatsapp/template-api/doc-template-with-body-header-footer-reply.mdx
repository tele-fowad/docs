---
title: "Document Template with Body, Header, Footer & Quick Reply"
sidebarTitle: "Document with Body & Quick Reply"
description: "This API is used for creating document templates with body, header, footer
and quick reply."
