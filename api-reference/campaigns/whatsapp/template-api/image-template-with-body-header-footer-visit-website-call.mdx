---
title: "Image Template with Body, Header, Footer, Visit Website and Call to Phone"
sidebarTitle: "Image with Body, Visit Website & Call"
description: "This API is used for creating image templates with body, header, footer,
