---
title: "Video Template with Body, Header & Footer"
sidebarTitle: "Video with Header & Footer"
description: "This API is used for creating video templates with body, header and footer."
...
```json SampleRequest.json
{
  ...
  "components": [
    ...
    {
      "type": "footer",
      "text": "Use the button your marketing subscriptions"
    },
    {
      "type": "buttons",
      "buttons": [
