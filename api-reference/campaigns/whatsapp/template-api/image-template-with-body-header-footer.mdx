---
title: "Image Template with Body, Header & Footer"
sidebarTitle: "Image with Header & Footer"
description: "This API is used for creating image templates with body, header and
footer."
